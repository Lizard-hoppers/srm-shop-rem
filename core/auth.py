...
def link_staff_telegram(conn: sqlite3.Connection, staff_id: int, telegram_id: int) -> None:
    conn.execute("UPDATE staff SET telegram_id = ? WHERE id = ?", (telegram_id, staff_id))
